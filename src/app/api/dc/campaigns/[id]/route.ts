...
export async function GET(
  ...
  try {
    ...
    const leadsSelect =
      "id, campaign_id, organization_id, lead_id, name, first_name, last_name, salutation, email, phone, direct_number, company_name, company_number, job_title, job_level, job_function, department, industry, employee_size, address, city, state, country, zip_code, status, qa_status, delivery_status, lead_tagging, lead_disposition, followup_date, assigned_agent_id, created_by, creator_display_name, created_at, updated_at, scored, appointment, revenue_range, revenue_link, contact_linkedin_url, company_linkedin_url, domain, phone_number_link, job_title_link, employee_size_link, company_website_link, sic_code, sic_code_link, naics_code, naics_code_link, founded_years, founded_years_link, see_all_employees, ra_comment, special_comments, call_back, call_notes, primary_reason, secondary_reason, qa_comments, disqualification_reasons, disqualification_reason, rectified_reason, cq1, cq2, cq3, cq4, cq5, extra_cq, audit_date, qa_name, asset_title, vv_status, email_status, ev_tool, tenurity, channel, notes";
